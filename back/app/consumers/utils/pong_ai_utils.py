...
async def stop_ai_game(id):
    ...
    # print("[STOP GAME]", id, file=sys.stderr)
    game = await get_ai_game(id)

    await send_ai_updates(id) # Send final update for the score

    # print("[STOP GAME] SAVING WINNER", id, file=sys.stderr)
