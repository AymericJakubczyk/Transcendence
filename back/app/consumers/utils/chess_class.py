...
class Pawn:
	...
	def setPossibleMoves(self, board, x, y):
		if (self.color == 'white'):
			...
			if (y - 1 >= 0 and x + 1 < 8 and board[y-1][x+1].piece and board[y-1][x+1].piece.color != self.color):
				board[y-1][x+1].possibleMove = 1
			if (y - 1 >= 0 and x - 1 >= 0 and board[y-1][x-1].piece and board[y-1][x-1].piece.color != self.color):
				board[y-1][x-1].possibleMove = 1
			...
			if (board[y+1][x].piece == 0):
				board[y+1][x].possibleMove = 1
			if (y + 1 < 8 and x + 1 < 8 and board[y+1][x+1].piece and board[y+1][x+1].piece.color != self.color):
				board[y+1][x+1].possibleMove = 1
			if (y + 1 < 8 and x - 1 >= 0 and board[y+1][x-1].piece and board[y+1][x-1].piece.color != self.color):
				board[y+1][x-1].possibleMove = 1
